...
root = Tk()
root.title('Download Manager V4.2')
...
file = Button(text='Integration Upgrade pip modules in Windows V1.0', command=interupgrdmodules)
file.place(x=330, y=300)

poetry = 'Downloader Manager V4.2 by HZF'
