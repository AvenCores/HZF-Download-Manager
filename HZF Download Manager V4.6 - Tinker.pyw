...
root = Tk()
root.title('Download Manager V4.6')
...
file = Button(text='Скачать HZF ORION Bomber V1.5.3 (LTS)', command=installHZFORIONBomber)
...
poetry = 'Downloader Manager V4.6 by HZF'
