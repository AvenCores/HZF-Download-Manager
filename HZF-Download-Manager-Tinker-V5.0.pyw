...
root = Tk()
root.title('Download Manager V5.0')
root.geometry('680x495')
...
def installWinControl():
            if platform == "linux" or platform == "linux2" or platform == "unix":
                messagebox.showinfo(title="Ошибка", message='Windows Control не поддерживает данную систему!')
