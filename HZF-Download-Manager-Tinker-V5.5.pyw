...
root = Tk()
root.title('Download Manager V5.4')
...
file = Button(text='Скачать HZF Tk Clock V3.1', command=installhzftkclock)
file.place(x=330, y=220)

file = Button(text='Скачать TG AVA DOWNLOAD V3.0', command=installtgavadwnld)
file.place(x=330, y=260)

file = Button(text='Скачать Integration Upgrade pip modules in Windows V3.1', command=interupgrdmodules)
file.place(x=330, y=300)

file = Button(text='Скачать Activator WinRAR V4.1', command=interupgrdmodules)
