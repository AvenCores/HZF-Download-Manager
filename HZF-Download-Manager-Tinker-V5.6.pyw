...
root = Tk()
root.title('Download Manager V5.6')
...
file = Button(text='Скачать HZF Tk Clock V2.5', command=installhzftkclock)
...
file = Button(text='Скачать Activator WinRAR V4.2', command=interupgrdmodules)
