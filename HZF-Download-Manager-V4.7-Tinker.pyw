...
root = Tk()
root.title('Download Manager V4.7')
root.geometry('680x445')
...
file = Button(text='Скачать HZF ORION Bomber V1.5.4 (LTS)', command=installHZFORIONBomber)
file.place(x=330, y=60)

file = Button(text='Скачать Upgrade pip modules V1.0', command=installpipupgrade)
file.place(x=330, y=180)

file = Button(text='Скачать HZF Tk Clock V2.3', command=installhzftkclock)
file.place(x=330, y=220)

file = Button(text='Скачать TG AVA DOWNLOAD V2.0', command=installtgavadwnld)
file.place(x=330, y=260)

file = Button(text='Скачать Integration Upgrade pip modules in Windows V2.0', command=interupgrdmodules)
file.place(x=330, y=300)

file = Button(text='Скачать Activator WinRAR', command=interupgrdmodules)
file.place(x=330, y=340)

file = Button(text='Скачать Windows Cleaner', command=interupgrdmodules)
file.place(x=330, y=380)

poetry = 'Downloader Manager V4.7 by HZF'
label3 = Label(text=poetry, justify=CENTER)
label3.place(x=225, y=420)
root.mainloop()
