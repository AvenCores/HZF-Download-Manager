...
# Запуск
* CMD - Вводим в Terminal: **python "HZF-Download-Manager-Terminal-V5.1.py"** / **"HZF-Download-Manager-Terminal-V5.1.exe"**
* GUI - Вводим в Terminal: **python "HZF-Download-Manager-Tinker-V5.1.pyw"** / **"HZF-Download-Manager-Tinker-V5.1.exe"**

# Менюдиректорию
![tk](https://i.imgur.com/AZpvbcL.png)
![cmd](https://i.imgur.com/zDZFGgH.png)
