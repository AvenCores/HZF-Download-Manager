...
# Запуск
* CMD - Вводим в Terminal: **python "HZF-Download-Manager-Terminal-V5.4.py"** / **"HZF-Download-Manager-Terminal-V5.4.exe"**
* GUI - Вводим в Terminal: **python "HZF-Download-Manager-Tinker-V5.4.pyw"** / **"HZF-Download-Manager-Tinker-V5.4.exe"**

# Менюдиректорию
![gui-tk-windows](https://i.imgur.com/xG759fc.png)
